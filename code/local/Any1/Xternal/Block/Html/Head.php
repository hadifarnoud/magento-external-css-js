...
/**
 * Any1 Xternal Html page block
 *
 * @category   Any1
 * @package    Any1_Xternal
 * @author     Vedran Subotic, Any1 <web@Any1.net>
 */
class Any1_Xternal_Block_Html_Head extends Mage_Page_Block_Html_Head
{
    /**
     * Initialize template
     *
